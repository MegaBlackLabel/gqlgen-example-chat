...
var sources = []*ast.Source{
	&ast.Source{Name: "graph/schema.graphqls", Input: `type Chatroom {
    name: String!
    messages: [Message!]!
}
...
func (ec *executionContext) _Chatroom_messages(ctx context.Context, field graphql.CollectedField, obj *model.Chatroom) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMessage2ᚕgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOChatroom2ᚖgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐChatroom(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_messageAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNMessage2ᚖgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v model.Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []model.Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2githubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v *model.Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOChatroom2githubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐChatroom(ctx context.Context, sel ast.SelectionSet, v model.Chatroom) graphql.Marshaler {
	return ec._Chatroom(ctx, sel, &v)
}

func (ec *executionContext) marshalOChatroom2ᚖgithubᚗcomᚋMegaBlackLabelᚋgqlgenᚑexampleᚑchatᚋgraphᚋmodelᚐChatroom(ctx context.Context, sel ast.SelectionSet, v *model.Chatroom) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Chatroom(ctx, sel, v)
